...
export function initCadastro() {
    const submitCadastro = document.querySelector('#btnSubmitCadastrar');
    ...
    telefone.addEventListener('keyup', () => {
        if (telefone.value == '') {
            ...
            spanTel.style.display = 'inline';
            spanTel.innerText =
                'Preencha o campo Telefone com no mínimo 9 caracteres.';
            telefone.focus();
            telefone.setAttribute('style', 'border-color: red');
            validTel = false;
            return false;
    ...
    senha.addEventListener('keyup', () => {
        if (senha.value == '') {
            ...
            spanSenha.style.display = 'inline';
            spanSenha.innerText =
                'Preencha o campo Senha com no mínimo 8 caracteres.';
            senha.focus();
            senha.setAttribute('style', 'border-color: red');
            validSenha = false;
            return false;
    ...
    confirmSenha.addEventListener('keyup', () => {
        if (confirmSenha.value != senha.value) {
            ...
            spanConf.innerText =
                'inconsistência encontrada. As senhas precisam ser iguais';
            confirmSenha.focus();
    ...
    submitCadastro.addEventListener('click', cadastrar);
}

export function initBtnVisibilityCadastro() {
    ...
    function toggleVisibilityInput(input) {
        input.setAttribute(
            'type',
    ...
    btnSenha.addEventListener('click', () => toggleVisibilityInput(inputSenha));

    btnConfirm.addEventListener('click', () =>
        toggleVisibilityInput(inputConfirmSenha),
    );
}
